                        ...
                        <div class="card-body">
                            <div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="fs-16 fw-semibold">Tổng Doanh Thu</span>
                                    <form class="">
                                        <select id="dynamic-select" name="example-select"
                                            data-placeholder="Select an option" data-dynamic-select>
                                            <option value="1" data-img="{{asset('assets/admin/images/logos/m-card.png')}}">xx25
                                            </option>
                                            <option value="2" data-img="{{asset('assets/admin/images/logos/ame-bank.png')}}">
                                                xx56</option>
                                        </select>
                                    </form>
                                </div> 
                                <h4 class="my-2 fs-24 fw-semibold"> {{ number_format($totalRevenue, 0, '.', ',') }}<small
                                        class="font-14">đ</small></h4>
                                <p class="mb-3 text-muted fw-semibold">
                                    <span class="text-success"><i
                                            class="fas fa-arrow-up me-1"></i>11.1%</span> Doanh Thu Tổng Của Tất Cả Các Tháng
                                </p>
                    ...
                    <div class="card bg-corner-img">
                        <div class="card-body">
                            <div class="row d-flex justify-content-center">
                                <div class="col-9">
                                    <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Tổng Số Đơn Hàng
                                    </p>
                                    <h4 class="mt-1 mb-0 fw-medium">{{$totalOrder}}</h4>
                                </div>
                                <!--end col-->
