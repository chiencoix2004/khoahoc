...
@section('content')
    <div class="container-fluid">
                ...
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    ...
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="#">Sửa Sản Phẩm</a>
                            </li><!--end nav-item-->
                        </ol>
                    </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <form 
                        action="{{ route('admin.products.editProduct',$editProduct->slug) }}" method="POST" 
                         id="uploadForm"  
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="name"
                                    value="{{ $editProduct->name }}" placeholder="Tên Sản Phẩm">
                            ...
                            <div class="mb-3">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div id="editor" class="form-control" style="height: auto;">
                                        {!! $editProduct->description !!} </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="{{ $editProduct->price }}" name="price"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="{{ $editProduct->price_sale }}"
                                name="price_sale" placeholder="Giá Giảm Sản Phẩm">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Chương Khóa Học</label>
                            <input type="text" class="form-control" id="" name="total_course"
                                value="{{ $editProduct->total_course }}" placeholder="Chương Khóa Học">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">URL Thư Mục</label>
                            <input type="text" class="form-control" id="" name="folder_url"
                                value="{{ $editProduct->folder_url }}" placeholder="URL Thư Mục">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Lượt Xem Sản Phẩm</label>
                            <input type="number" class="form-control" id="" name="view"
                                value="{{ $editProduct->view }}" placeholder="Lượt Xem Sản Phẩm">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Lượt Bán Sản Phẩm</label>
                            <input type="number" class="form-control" id="" name="buys"
                                value="{{ $editProduct->buys }}" placeholder="Lượt Bán Sản Phẩm">
                        </div>
                        ...
                        <div class="col-xxl-12 col-md-6 mb-4">
                            ...
                            <select name="category" class="form-select" id="subCategory"
                        ...
                        <div class="col-xxl-12 col-md-6 mb-4">
                            ...
                            <select class="form-select" id="category" name="parent_category"
                                onchange="loadSubCategories(this.value)">
                                <option value=""
                                    {{ old('parent_category', $editProduct->categoryParentId() ?? '') == '' ? 'selected' : '' }}>
                                    Lựa Chọn
                                </option>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ old('parent_category', $editProduct->categoryParentId() ?? '') == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-xxl-12 col-md-6 mb-4">
                            ...
                            <select name="category" class="form-select" id="subCategory">
                                <option value=""
                                    {{ old('category', $editProduct->id_category ?? '') == '' ? 'selected' : '' }}>
                                    Lựa Chọn
                                </option>
                                <!-- Các danh mục con sẽ được nạp tự động -->
                            </select>
        ...
        <script>
                ...
                if (parentId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            "{{ old('category', $editProduct->id_category ?? '') }}"; // Giá trị danh mục con từ id_category
                            data.forEach(subCategory => {
                                subCategorySelect.append(
            ...
            // Khi trang tải, tự động hiển thị danh mục con đã chọn
