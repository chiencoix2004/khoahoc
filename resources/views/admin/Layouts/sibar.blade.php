<div class="startbar d-print-none">
    ...
    <div class="brand">
        <a href="{{route('admin.dashboard')}}" class="logo">
            ...
            <span class="">
                <img src="{{asset('assets/admin/images/logo-light.png')}}" alt="logo-large" class="logo-lg logo-light">
        ...
        <div class="startbar-collapse" id="startbarCollapse" data-simplebar>
            <div class="d-flex align-items-start flex-column w-100">
                ...
                <ul class="navbar-nav mb-auto w-100">
                    ...
                    <li class="nav-item {{ (request()->is('admin/products/detailProduct/*') || request()->is('admin/products/addProduct') || request()->is('admin/products/editProduct/*')) ? 'active' : '' }}">
                        <a class="nav-link {{ (request()->is('admin/products/detailProduct/*') || request()->is('admin/products/addProduct') || request()->is('admin/products/editProduct/*')) ? 'active' : '' }}" href="{{ route('admin.products.listProduct') }}">
                            <i class="iconoir-cart menu-icon"></i>
                            <span>Sản Phẩm</span>
                        </a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.orders.ListOrder')}}">
